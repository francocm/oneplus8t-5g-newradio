...
* The provided files are severely outdated in terms of base
    ...
    * Based on XML version `16.11.21`, whereas this is based on the one provided in the EU stable OP8T firmware (`Oxygen OS 11.0.6.9.KB05BA` - January 2021): `16.23.6` / `16.29.8`
